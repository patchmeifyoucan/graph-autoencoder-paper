...
makes gradient descent on the neural network output ineffective as the loss is not unique for a particular prediction.
...
However, this does not unlock the full potential as only a graph-level representation is meaningful, for example,
