...
\textcolor{red}{TODO: should start more general, with general representation learning on graphs or so.}
...
Learning to map back a graph embedding to a graph representation is challenging for the following reasons.
